...
# 📖 Cart Management <a name="about-project">

Hi there! Welcome to my Cart Management web app</a>

A cart management web app is a web application that allows users to manage their online shopping carts. This app is designed to simplify the process of managing and tracking items in a user's cart, from adding and removing items to updating quantities and checking out
...
```snippet
  git clone https://github.com/UbdaNam/cart-management-redux.git
```
...
Feel free to check the [issues page](https://github.com/UbdaNam/cart-management-redux/issues).
